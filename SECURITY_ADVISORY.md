...
- **上游原版:**不受影响。缺陷位于 fork 扩展包,上游文件零改动(README 顶部横幅为唯一登记例外,见 FORK_NOTES.md)(FORK_NOTES.md 既禁核心改动也禁包私有重写)。
...
| 08-27 21:34–21:41 | 修复版进入持续运行的公网隧道部署;验收含"token 入口 → 302 + Set-Cookie → 带 cookie 200" | `87e72e4f9f`、`e7ae68ca2c` |
| 08-27 | 本通告发布 | 本文件 |
