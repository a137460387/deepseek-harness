...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-long-text-fold LongTextFoldNodeView key \'user\'',
      'client-long-text-fold LongTextFoldNodeView key \'steering\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-draft-budget DraftBudgetReadout id \'draft-budget\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-long-text-fold LongTextFoldDock id \'long-text-fold\'',
      'client-text-file-cards TextFileCardsDock id \'text-file-cards\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-usage-stats UsageStatsSection id \'usage-stats\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-find-in-chat FindBar id \'find-in-chat\'',
      'client-long-text-fold PreviewPopup id \'long-text-fold-preview\'',
    ],
    replaceRisk: 'none',
