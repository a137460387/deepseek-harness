...
/** Read one provider usage sample from either durable carrier: the direct
 * `usage` field first, else the last stream usage chunk — a line-parallel of
 * token-meter's `usageOf`. */
